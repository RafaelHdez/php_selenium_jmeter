...
class TestPruebaParcial:
  def setup_method(self, method):
    self.driver = webdriver.Firefox()  # Usar Firefox como navegador
    self.vars = {}
    ...
    with open("resultados_selenium.log", "w") as log_file:
      for i in range(100):  # Ejecutar la prueba 100 veces
        try:
          ...
          self.driver.get("http://localhost/simple-login/index.php")
          self.driver.set_window_size(801, 692)

          # Ingresar credenciales
          self.driver.find_element(By.NAME, "email").send_keys("correoadmin@admin.com")
          self.driver.find_element(By.NAME, "password").send_keys("contra1234")
